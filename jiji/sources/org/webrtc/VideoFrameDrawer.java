        ...
        public int[] uploadYuvData(int i, int i2, int[] iArr, ByteBuffer[] byteBufferArr) {
            ...
            if (this.yuvTextures == null) {
                ...
                for (int i9 = 0; i9 < 3; i9++) {
                    this.yuvTextures[i9] = GlUtil.generateTexture(GLConst.GL_TEXTURE_2D);
                }
            }
            for (int i10 = 0; i10 < 3; i10++) {
                GLES20.glActiveTexture(33984 + i10);
                GLES20.glBindTexture(GLConst.GL_TEXTURE_2D, this.yuvTextures[i10]);
                int i11 = iArr[i10];
                int i12 = iArr2[i10];
                if (i11 == i12) {
                ...
                GLES20.glTexImage2D(GLConst.GL_TEXTURE_2D, 0, 6409, iArr2[i10], iArr3[i10], 0, 6409, 5121, byteBuffer);
            }
