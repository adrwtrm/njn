...
public class CameraEnumerationAndroid {
    static final ArrayList<Size> COMMON_RESOLUTIONS = new ArrayList<>(Arrays.asList(new Size(160, 120), new Size(240, 160), new Size(TokenId.IF, 240), new Size(TokenId.Identifier, 240), new Size(CameraConst.DEFAULT_HEIGHT, TokenId.IF), new Size(CameraConst.DEFAULT_WIDTH, TokenId.EXOR_E), new Size(CameraConst.DEFAULT_WIDTH, CameraConst.DEFAULT_HEIGHT), new Size(768, CameraConst.DEFAULT_HEIGHT), new Size(854, CameraConst.DEFAULT_HEIGHT), new Size(Defines.PDF_MAX_H, 600), new Size(960, 540), new Size(960, CameraConst.DEFAULT_WIDTH), new Size(1024, 576), new Size(1024, 600), new Size(Defines.PDF_MAX_W, 720), new Size(Defines.PDF_MAX_W, 1024), new Size(1920, 1080), new Size(1920, 1440), new Size(2560, 1440), new Size(3840, 2160)));
