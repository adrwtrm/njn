...
public class Camera2Session implements CameraSession {
    ...
    public class CaptureSessionCallback extends CameraCaptureSession.StateCallback {
            ...
            try {
                ...
                Camera2Session.this.surfaceTextureHelper.startListening(new VideoSink() { // from class: org.webrtc.Camera2Session$CaptureSessionCallback$$ExternalSyntheticLambda0
                    ...
                    public final void onFrame(VideoFrame videoFrame) {
                        Camera2Session.CaptureSessionCallback.this.m1906x8bd2b057(videoFrame);
                    }
                });
        ...
        public /* synthetic */ void m1906x8bd2b057(VideoFrame videoFrame) {
            Camera2Session.this.checkIsOnCameraThread();
    ...
    public int getFrameOrientation() {
        ...
        return (this.cameraOrientation + deviceOrientation) % TokenId.EXOR_E;
    }
