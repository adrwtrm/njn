...
public class SurfaceEglRenderer extends EglRenderer implements SurfaceHolder.Callback {
    ...
    /* renamed from: $r8$lambda$xXX-ywdCqM5leaxXkxy473i7s2A */
    public static /* synthetic */ void m1917$r8$lambda$xXXywdCqM5leaxXkxy473i7s2A(CountDownLatch countDownLatch) {
    ...
    public void surfaceDestroyed(SurfaceHolder surfaceHolder) {
        ...
        releaseEglSurface(new Runnable() { // from class: org.webrtc.SurfaceEglRenderer$$ExternalSyntheticLambda0
            ...
            public final void run() {
                SurfaceEglRenderer.m1917$r8$lambda$xXXywdCqM5leaxXkxy473i7s2A(countDownLatch);
            }
        });
