...
public class AndroidVideoDecoder implements VideoDecoder, VideoSink {
    ...
    private VideoCodecStatus initDecodeInternal(int i, int i2) {
        Logging.e(TAG, "initDecodeInternal()");
    ...
    public VideoCodecStatus decode(EncodedImage encodedImage, VideoDecoder.DecodeInfo decodeInfo) {
        ...
        if (this.codec == null || this.callback == null) {
            ...
            if (encodedImage.encodedWidth * encodedImage.encodedHeight > 0 && (encodedImage.encodedWidth != i || encodedImage.encodedHeight != i2)) {
                Logging.e(TAG, "decode() reinitDecode");
            ...
            if (this.keyFrameRequired) {
                Logging.e(TAG, "decode() keyFrameRequired");
            ...
            try {
                ...
                Logging.e(TAG, "decode() index " + dequeueInputBuffer);
                ...
                try {
                    ...
                    try {
                        ...
                        if (this.keyFrameRequired) {
                            Logging.e(TAG, "decode() keyFrameRequired = false");
                            this.keyFrameRequired = false;
                        }
                        Logging.e(TAG, "decode() VideoCodecStatus.OK");
                        return VideoCodecStatus.OK;
    ...
    private Thread createOutputThread() {
        Logging.e(TAG, "createOutputThread()");
    ...
    protected void deliverDecodedFrame() {
        Integer num;
        int i;
        Logging.e(TAG, "deliverDecodedFrame");
        this.outputThreadChecker.checkIsOnValidThread();
        try {
            MediaCodec.BufferInfo bufferInfo = new MediaCodec.BufferInfo();
            Logging.e(TAG, "dequeueOutputBuffer");
            int dequeueOutputBuffer = this.codec.dequeueOutputBuffer(bufferInfo, 100000L);
            Logging.e(TAG, "get dequeueOutputBuffer");
            if (dequeueOutputBuffer == -2) {
                Logging.e(TAG, "MediaCodec.INFO_OUTPUT_FORMAT_CHANGED");
                Logging.e(TAG, "reformat");
                ...
                if (this.surfaceTextureHelper != null) {
                    Logging.e(TAG, "deliverTextureFrame");
                    deliverTextureFrame(dequeueOutputBuffer, bufferInfo, i, num);
                    return;
                }
                Logging.e(TAG, "deliverByteFrame");
    ...
    public void releaseCodecOnOutputThread() {
        Logging.e(TAG, "releaseCodecOnOutputThread()");
        this.outputThreadChecker.checkIsOnValidThread();
    ...
    private void stopOnOutputThread(Exception exc) {
        Logging.e(TAG, "stopOnOutputThread()");
        this.outputThreadChecker.checkIsOnValidThread();
        this.running = false;
