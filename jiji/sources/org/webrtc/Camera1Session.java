...
public class Camera1Session implements CameraSession {
    ...
    private void listenForTextureFrames() {
        this.surfaceTextureHelper.startListening(new VideoSink() { // from class: org.webrtc.Camera1Session$$ExternalSyntheticLambda0
            ...
            public final void onFrame(VideoFrame videoFrame) {
                Camera1Session.this.m1903lambda$listenForTextureFrames$0$orgwebrtcCamera1Session(videoFrame);
            }
        });
    }
    ...
    public /* synthetic */ void m1903lambda$listenForTextureFrames$0$orgwebrtcCamera1Session(VideoFrame videoFrame) {
        checkIsOnCameraThread();
    ...
    public class AnonymousClass2 implements Camera.PreviewCallback {
            ...
            if (camera == Camera1Session.this.camera) {
                ...
                VideoFrame videoFrame = new VideoFrame(new NV21Buffer(bArr, Camera1Session.this.captureFormat.width, Camera1Session.this.captureFormat.height, new Runnable() { // from class: org.webrtc.Camera1Session$2$$ExternalSyntheticLambda1
                    ...
                    public final void run() {
                        Camera1Session.AnonymousClass2.this.m1905lambda$onPreviewFrame$1$orgwebrtcCamera1Session$2(bArr);
                    }
        ...
        public /* synthetic */ void m1905lambda$onPreviewFrame$1$orgwebrtcCamera1Session$2(final byte[] bArr) {
            Camera1Session.this.cameraThreadHandler.post(new Runnable() { // from class: org.webrtc.Camera1Session$2$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                    Camera1Session.AnonymousClass2.this.m1904lambda$onPreviewFrame$0$orgwebrtcCamera1Session$2(bArr);
                }
            });
        }
        ...
        public /* synthetic */ void m1904lambda$onPreviewFrame$0$orgwebrtcCamera1Session$2(byte[] bArr) {
            if (Camera1Session.this.state == SessionState.RUNNING) {
    ...
    public int getFrameOrientation() {
        ...
        return (this.info.orientation + deviceOrientation) % TokenId.EXOR_E;
    }
