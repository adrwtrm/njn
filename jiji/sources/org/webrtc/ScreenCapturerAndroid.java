...
public class ScreenCapturerAndroid implements VideoCapturer, VideoSink {
    private static final int DISPLAY_FLAGS = 17;
    ...
    public void createVirtualDisplay() {
        ...
        this.virtualDisplay = this.mediaProjection.createVirtualDisplay("WebRTC_ScreenCapture", this.width, this.height, 400, 17, new Surface(this.surfaceTextureHelper.getSurfaceTexture()), null, null);
    }
