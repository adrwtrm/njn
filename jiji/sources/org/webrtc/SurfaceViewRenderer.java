...
public class SurfaceViewRenderer extends SurfaceView implements SurfaceHolder.Callback, VideoSink, RendererCommon.RendererEvents {
    ...
    public void onFrameResolutionChanged(final int i, int i2, int i3) {
        ...
        postOrRun(new Runnable() { // from class: org.webrtc.SurfaceViewRenderer$$ExternalSyntheticLambda0
            ...
            public final void run() {
                SurfaceViewRenderer.this.m1925lambda$onFrameResolutionChanged$0$orgwebrtcSurfaceViewRenderer(i4, i);
            }
        });
    }
    ...
    public /* synthetic */ void m1925lambda$onFrameResolutionChanged$0$orgwebrtcSurfaceViewRenderer(int i, int i2) {
