...
public final class LinkifyCompat {
    ...
    public static boolean addLinks(Spannable spannable, int i) {
        ...
        if ((i & 1) != 0) {
            gatherLinks(arrayList, spannable, PatternsCompat.AUTOLINK_WEB_URL, new String[]{WebUtils.URL_PREF_HTTP, WebUtils.URL_PREF_HTTPS, "rtsp://"}, Linkify.sUrlMatchFilter, null);
        }
        if ((i & 2) != 0) {
