...
public final class SimpleActor<T> {
    ...
    public SimpleActor(CoroutineScope scope, final Function1<? super Throwable, Unit> onComplete, final Function2<? super T, ? super Throwable, Unit> onUndeliveredElement, Function2<? super T, ? super Continuation<? super Unit>, ? extends Object> consumeMessage) {
        ...
        job.invokeOnCompletion(new Function1<Throwable, Unit>() { // from class: androidx.datastore.core.SimpleActor.1
            ...
            public final void invoke2(Throwable th) {
                ...
                do {
                    Object m1854getOrNullimpl = ChannelResult.m1854getOrNullimpl(((SimpleActor) this).messageQueue.mo1843tryReceivePtdJZtk());
                    if (m1854getOrNullimpl == null) {
                        unit = null;
                        continue;
                    } else {
                        onUndeliveredElement.invoke(m1854getOrNullimpl, th);
                        unit = Unit.INSTANCE;
                        continue;
                    }
                } while (unit != null);
    ...
    public final void offer(T t) {
        Object obj = this.messageQueue.mo1844trySendJP2dKIU(t);
        if (obj instanceof ChannelResult.Closed) {
            Throwable m1853exceptionOrNullimpl = ChannelResult.m1853exceptionOrNullimpl(obj);
            if (m1853exceptionOrNullimpl != null) {
                throw m1853exceptionOrNullimpl;
            }
            throw new ClosedSendChannelException("Channel was closed normally");
        } else if (!ChannelResult.m1859isSuccessimpl(obj)) {
