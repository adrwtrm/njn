...
public final class ExtensionEmbeddingBackend implements EmbeddingBackend {
    ...
    public static final class SplitListenerWrapper {
        ...
        public static /* synthetic */ void $r8$lambda$R0583vPiK5P4651WzcCfIdW6hLQ(SplitListenerWrapper splitListenerWrapper, List list) {
            m53accept$lambda1(splitListenerWrapper, list);
        }
        ...
        public final void accept(List<SplitInfo> splitInfoList) {
            ...
            this.executor.execute(new Runnable() { // from class: androidx.window.embedding.ExtensionEmbeddingBackend$SplitListenerWrapper$$ExternalSyntheticLambda0
                ...
                public final void run() {
                    ExtensionEmbeddingBackend.SplitListenerWrapper.$r8$lambda$R0583vPiK5P4651WzcCfIdW6hLQ(ExtensionEmbeddingBackend.SplitListenerWrapper.this, arrayList2);
                }
            });
        }
