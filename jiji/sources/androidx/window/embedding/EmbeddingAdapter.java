...
public final class EmbeddingAdapter {
    /* renamed from: $r8$lambda$-QlFe7fckaSVTLCegr9_8uxVaa4 */
    public static /* synthetic */ boolean m45$r8$lambda$QlFe7fckaSVTLCegr9_8uxVaa4(Set set, Activity activity) {
        return m50translateActivityPredicates$lambda6(set, activity);
    }

    public static /* synthetic */ boolean $r8$lambda$nSea4sfI4EFFkXqov0va87aZ_68(SplitRule splitRule, WindowMetrics windowMetrics) {
        return m52translateParentMetricsPredicate$lambda4(splitRule, windowMetrics);
    }

    public static /* synthetic */ boolean $r8$lambda$x8eGFLpnqP7STokqkg3obw9dl5Q(EmbeddingAdapter embeddingAdapter, Set set, Pair pair) {
        return m48translateActivityIntentPredicates$lambda3(embeddingAdapter, set, pair);
    }

    /* renamed from: $r8$lambda$xf-Lop7h3ngH6EmzyuDyOYtb8Lk */
    public static /* synthetic */ boolean m46$r8$lambda$xfLop7h3ngH6EmzyuDyOYtb8Lk(EmbeddingAdapter embeddingAdapter, Set set, Pair pair) {
        return m49translateActivityPairPredicates$lambda1(embeddingAdapter, set, pair);
    }

    /* renamed from: $r8$lambda$yScxR8XDNmwEhhX_T4Oe1hesc-c */
    public static /* synthetic */ boolean m47$r8$lambda$yScxR8XDNmwEhhX_T4Oe1hescc(Set set, Intent intent) {
        return m51translateIntentPredicates$lambda8(set, intent);
    }
    ...
    public final Predicate<Pair<Activity, Activity>> translateActivityPairPredicates(final Set<SplitPairFilter> splitPairFilters) {
        ...
        return new Predicate() { // from class: androidx.window.embedding.EmbeddingAdapter$$ExternalSyntheticLambda4
            ...
            public final boolean test(Object obj) {
                return EmbeddingAdapter.m46$r8$lambda$xfLop7h3ngH6EmzyuDyOYtb8Lk(EmbeddingAdapter.this, splitPairFilters, (Pair) obj);
            }
        };
    }
    ...
    public final Predicate<Pair<Activity, Intent>> translateActivityIntentPredicates(final Set<SplitPairFilter> splitPairFilters) {
        ...
        return new Predicate() { // from class: androidx.window.embedding.EmbeddingAdapter$$ExternalSyntheticLambda0
            @Override // java.util.function.Predicate
            public final boolean test(Object obj) {
                return EmbeddingAdapter.$r8$lambda$x8eGFLpnqP7STokqkg3obw9dl5Q(EmbeddingAdapter.this, splitPairFilters, (Pair) obj);
            }
        };
    }
    ...
    public final Predicate<WindowMetrics> translateParentMetricsPredicate(final SplitRule splitRule) {
        ...
        return new Predicate() { // from class: androidx.window.embedding.EmbeddingAdapter$$ExternalSyntheticLambda2
            @Override // java.util.function.Predicate
            public final boolean test(Object obj) {
                return EmbeddingAdapter.$r8$lambda$nSea4sfI4EFFkXqov0va87aZ_68(SplitRule.this, (WindowMetrics) obj);
            }
        };
    }
    ...
    public final Predicate<Activity> translateActivityPredicates(final Set<ActivityFilter> activityFilters) {
        ...
        return new Predicate() { // from class: androidx.window.embedding.EmbeddingAdapter$$ExternalSyntheticLambda1
            @Override // java.util.function.Predicate
            public final boolean test(Object obj) {
                return EmbeddingAdapter.m45$r8$lambda$QlFe7fckaSVTLCegr9_8uxVaa4(activityFilters, (Activity) obj);
            }
        };
    }
    ...
    public final Predicate<Intent> translateIntentPredicates(final Set<ActivityFilter> activityFilters) {
        ...
        return new Predicate() { // from class: androidx.window.embedding.EmbeddingAdapter$$ExternalSyntheticLambda3
            @Override // java.util.function.Predicate
            public final boolean test(Object obj) {
                return EmbeddingAdapter.m47$r8$lambda$yScxR8XDNmwEhhX_T4Oe1hescc(activityFilters, (Intent) obj);
            }
        };
    }
