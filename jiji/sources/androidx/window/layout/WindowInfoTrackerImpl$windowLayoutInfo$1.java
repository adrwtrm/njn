...
final class WindowInfoTrackerImpl$windowLayoutInfo$1 extends SuspendLambda implements Function2<FlowCollector<? super WindowLayoutInfo>, Continuation<? super Unit>, Object> {
    ...
    public static /* synthetic */ void $r8$lambda$LgDWJbk4b494d79uZZm3iJ0WM6A(Channel channel, WindowLayoutInfo windowLayoutInfo) {
        m55invokeSuspend$lambda0(channel, windowLayoutInfo);
    }
    ...
    */
    ...
    public static final void m55invokeSuspend$lambda0(Channel channel, WindowLayoutInfo info) {
        Intrinsics.checkNotNullExpressionValue(info, "info");
        channel.mo1844trySendJP2dKIU(info);
    }
}
