...
public final class ViewDataBindingKtx {
    ...
    private static final CreateWeakListener CREATE_STATE_FLOW_LISTENER = new CreateWeakListener() { // from class: androidx.databinding.ViewDataBindingKtx$$ExternalSyntheticLambda0
        ...
        public final WeakListener create(ViewDataBinding viewDataBinding, int i, ReferenceQueue referenceQueue) {
            return ViewDataBindingKtx.$r8$lambda$EszaTROqECUB3IZADKQJvHvRaaA(viewDataBinding, i, referenceQueue);
        }
    };

    public static /* synthetic */ WeakListener $r8$lambda$EszaTROqECUB3IZADKQJvHvRaaA(ViewDataBinding viewDataBinding, int i, ReferenceQueue referenceQueue) {
        return CREATE_STATE_FLOW_LISTENER$lambda$0(viewDataBinding, i, referenceQueue);
    }
