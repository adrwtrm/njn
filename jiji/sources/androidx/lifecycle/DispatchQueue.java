...
public final class DispatchQueue {
    ...
    public static /* synthetic */ void m39$r8$lambda$1MEFmJywCV2uxhp8ajM5a9C_oI(DispatchQueue dispatchQueue, Runnable runnable) {
    ...
    public final void dispatchAndEnqueue(CoroutineContext context, final Runnable runnable) {
        ...
        if (immediate.isDispatchNeeded(context) || canRun()) {
            immediate.mo1890dispatch(context, new Runnable() { // from class: androidx.lifecycle.DispatchQueue$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                    DispatchQueue.m39$r8$lambda$1MEFmJywCV2uxhp8ajM5a9C_oI(DispatchQueue.this, runnable);
                }
            });
        } else {
            enqueue(runnable);
