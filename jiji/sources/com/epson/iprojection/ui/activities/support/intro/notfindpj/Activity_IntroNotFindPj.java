...
public class Activity_IntroNotFindPj extends BaseIntroActivity {
    protected static final int[] IMG_ID = {R.id.img_proc00, R.id.img_proc01, R.id.img_proc02, R.id.img_proc03};
    ...
    public void onCreate(Bundle bundle) {
        ...
        super.initialize(R.layout.main_intro_notfindpj, IMG_ID);
    }
