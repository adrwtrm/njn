...
import com.epson.iprojection.ui.activities.remote.commandsend.state.DigestEscvpSendingState;
...
@DebugMetadata(c = "com.epson.iprojection.ui.activities.remote.commandsend.state.DigestEscvpSendingState$showInputPasswordDialog$1", f = "DigestEscvpSendingState.kt", i = {}, l = {}, m = "invokeSuspend", n = {}, s = {})
...
public final class DigestEscvpSendingState$showInputPasswordDialog$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        D_HistoryInfo info = this.this$0.get_contextData().getPjList().get(this.this$0.get_contextData().getPjIndex()).getInfo();
        Contract.IView iview = this.this$0.get_contextData().getIview();
        String str = info.pjName;
        Intrinsics.checkNotNullExpressionValue(str, "pjInfo.pjName");
        this.this$0.get_contextData().getIview().createPasswordInputDialogFrom(iview.createLayoutInPasswordInputDialog(str, this.this$0.get_contextData().getPjList().size() == 1), info, new DigestEscvpSendingState.ImplIOnClickDialogButton());
