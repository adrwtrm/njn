...
public class ToolbarProfileBindingImpl extends ToolbarProfileBinding {
    ...
    static {
        ...
        sparseIntArray.put(R.id.toolbarProfile, 2);
        sparseIntArray.put(R.id.left_guideline, 3);
        sparseIntArray.put(R.id.txt_titlebar_filename, 4);
        sparseIntArray.put(R.id.btnTitleSearch, 5);
        sparseIntArray.put(R.id.right_guideline, 6);
    }

    public ToolbarProfileBindingImpl(DataBindingComponent dataBindingComponent, View view) {
        this(dataBindingComponent, view, mapBindings(dataBindingComponent, view, 7, sIncludes, sViewsWithIds));
    }

    private ToolbarProfileBindingImpl(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
