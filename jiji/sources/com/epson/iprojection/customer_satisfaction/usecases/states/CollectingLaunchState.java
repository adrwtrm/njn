...
public final class CollectingLaunchState extends CollectingState {
    ...
    public CollectingLaunchState(StoreReviewCollectInterface storeReviewPresenter, SatisfactionCollectInterface satisfactionPresenter, CSStoreInterface repository, CSAnalyticsInterface analytics, CSAssistanceInterface assistance, CoroutineScope coroutineScope) {
