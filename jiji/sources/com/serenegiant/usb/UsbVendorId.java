...
public class UsbVendorId {
    ...
    static {
        ...
        sparseArray.put(PointerIconCompat.TYPE_HELP, "Atmel Corporation");
        sparseArray.put(PointerIconCompat.TYPE_CELL, "Mitsumi");
        sparseArray.put(PointerIconCompat.TYPE_TEXT, "HP Inc.");
        ...
        sparseArray.put(CommonDefine.REQUEST_CODE_WEB_INPUT_FILE, "Quanta Computer Inc.");
        sparseArray.put(10329, "Viconn Technology (HK) Co., Ltd.");
        sparseArray.put(CommonDefine.REQUEST_CODE_WEB_SAF, "NEC Corporation");
        ...
        sparseArray.put(CommonDefine.REQUEST_CODE_LOCATION_PERMISSION_FOR_REGISTRATION, "BUFFALO INC.");
    ...
    public static String vendorName(int i) {
        ...
        return TextUtils.isEmpty(str) ? String.format(Locale.US, "VendorId%08x", Integer.valueOf(i)) : str;
    }
}
