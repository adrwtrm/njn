...
public class SwipeRefreshLayout extends ViewGroup implements NestedScrollingParent, NestedScrollingChild, NestedScrollingParent2, NestedScrollingChild2, NestedScrollingParent3, NestedScrollingChild3 {
    ...
    void reset() {
        postDelayed(new Runnable() { // from class: com.serenegiant.widget.SwipeRefreshLayout$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() {
                SwipeRefreshLayout.this.m287lambda$reset$0$comserenegiantwidgetSwipeRefreshLayout();
            }
        }, 300L);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    /* renamed from: lambda$reset$0$com-serenegiant-widget-SwipeRefreshLayout  reason: not valid java name */
    public /* synthetic */ void m287lambda$reset$0$comserenegiantwidgetSwipeRefreshLayout() {
    ...
    public static class SavedState extends View.BaseSavedState {
        public static final Parcelable.Creator<SavedState> CREATOR = new Parcelable.Creator<SavedState>() { // from class: com.serenegiant.widget.SwipeRefreshLayout.SavedState.1
    ...
    public SwipeRefreshLayout(Context context, AttributeSet attributeSet) {
        ...
        this.mRefreshListener = new Animation.AnimationListener() { // from class: com.serenegiant.widget.SwipeRefreshLayout.1
            ...
            public void onAnimationEnd(Animation animation) {
                if (SwipeRefreshLayout.this.mRefreshing) {
                    SwipeRefreshLayout.this.setProgressAlpha(255);
        ...
        this.mAnimateToCorrectPosition = new Animation() { // from class: com.serenegiant.widget.SwipeRefreshLayout.6
        ...
        this.mAnimateToStartPosition = new Animation() { // from class: com.serenegiant.widget.SwipeRefreshLayout.7
            @Override // android.view.animation.Animation
            public void applyTransformation(float f, Transformation transformation) {
        ...
        try {
            this.mProgressViewId = obtainStyledAttributes.getResourceId(R.styleable.SwipeRefreshLayout_progressView, -1);
    ...
    protected void onAttachedToWindow() {
        ...
        if (this.mCircleView == null) {
            View findViewInParent = ViewUtils.findViewInParent(this, new int[]{this.mProgressViewId, R.id.progressView}, View.class);
            if (findViewInParent == null) {
                this.mOwnProgressView = true;
                findViewInParent = new AnimationProgressBar(getContext());
                addView(findViewInParent);
            }
            setProgressView(findViewInParent);
        }
        moveToStart(1.0f);
    }
    ...
    private int getProgressAlpha() {
        ...
        return background != null ? background.getAlpha() : (int) (this.mCircleView.getAlpha() * 255.0f);
    }
    ...
    public void setProgressAlpha(int i) {
        ...
        if (background != null) {
            ...
            this.mCircleView.setAlpha(i / 255.0f);
        }
    }
    ...
    private void startScaleUpAnimation(Animation.AnimationListener animationListener) {
        ...
        if (view != null) {
            ...
            Animation animation = new Animation() { // from class: com.serenegiant.widget.SwipeRefreshLayout.2
                @Override // android.view.animation.Animation
                public void applyTransformation(float f, Transformation transformation) {
            ...
            if ((view2 instanceof IAnimationView) && animationListener != null) {
                ((IAnimationView) view2).setAnimationListener(animationListener);
            }
            this.mCircleView.clearAnimation();
    ...
    void startScaleDownAnimation(Animation.AnimationListener animationListener) {
        Animation animation = new Animation() { // from class: com.serenegiant.widget.SwipeRefreshLayout.3
            @Override // android.view.animation.Animation
            public void applyTransformation(float f, Transformation transformation) {
        ...
        View view = this.mCircleView;
        if ((view instanceof IAnimationView) && animationListener != null) {
            ((IAnimationView) view).setAnimationListener(animationListener);
        }
        this.mCircleView.clearAnimation();
    ...
    private void startProgressAlphaMaxAnimation() {
        this.mAlphaMaxAnimation = startAlphaAnimation(getProgressAlpha(), 255);
    }

    private Animation startAlphaAnimation(final int i, final int i2) {
        Animation animation = new Animation() { // from class: com.serenegiant.widget.SwipeRefreshLayout.4
            @Override // android.view.animation.Animation
            public void applyTransformation(float f, Transformation transformation) {
                SwipeRefreshLayout swipeRefreshLayout = SwipeRefreshLayout.this;
                int i3 = i;
                swipeRefreshLayout.setProgressAlpha((int) (i3 + ((i2 - i3) * f)));
            }
        };
        animation.setDuration(300L);
        View view = this.mCircleView;
        if (view instanceof IAnimationView) {
            ((IAnimationView) view).setAnimationListener(null);
        }
        this.mCircleView.clearAnimation();
    ...
    private void moveSpinner(float f) {
        ...
        if (f < this.mTotalDragDistance) {
            if (getProgressAlpha() > 76 && !isAnimationRunning(this.mAlphaStartAnimation)) {
                startProgressAlphaStartAnimation();
            }
        } else if (getProgressAlpha() < 255 && !isAnimationRunning(this.mAlphaMaxAnimation)) {
    ...
    private void finishSpinner(float f) {
        ...
        this.mRefreshing = false;
        animateOffsetToStartPosition(this.mCurrentTargetOffsetTop, !this.mScale ? new Animation.AnimationListener() { // from class: com.serenegiant.widget.SwipeRefreshLayout.5
            @Override // android.view.animation.Animation.AnimationListener
            public void onAnimationRepeat(Animation animation) {
            }
    ...
    void moveToStart(float f) {
        int i = this.mFrom;
        int i2 = i + ((int) ((this.mOriginalOffsetTop - i) * f));
        View view = this.mCircleView;
        setTargetOffsetTopAndBottom(i2 - (view != null ? view.getTop() : 0));
    }

    private void startScaleDownReturnToStartAnimation(int i, Animation.AnimationListener animationListener) {
        this.mFrom = i;
        this.mStartingScale = this.mCircleView.getScaleX();
        Animation animation = new Animation() { // from class: com.serenegiant.widget.SwipeRefreshLayout.8
            @Override // android.view.animation.Animation
            public void applyTransformation(float f, Transformation transformation) {
