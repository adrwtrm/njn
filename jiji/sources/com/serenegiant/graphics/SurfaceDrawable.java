...
public class SurfaceDrawable extends Drawable {
    ...
    public SurfaceDrawable(int i, int i2, int i3, Callback callback) {
        ...
        this.mInvalidateSelfOnUITask = new Runnable() { // from class: com.serenegiant.graphics.SurfaceDrawable.2
            @Override // java.lang.Runnable
            public void run() {
                SurfaceDrawable.this.invalidateSelf();
            }
        };
        this.mOnFrameAvailableListener = new SurfaceTexture.OnFrameAvailableListener() { // from class: com.serenegiant.graphics.SurfaceDrawable.3
        ...
        EglTask eglTask = new EglTask(i3, null, 0, i, i2) { // from class: com.serenegiant.graphics.SurfaceDrawable.1
