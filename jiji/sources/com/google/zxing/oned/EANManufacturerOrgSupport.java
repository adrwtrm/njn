...
final class EANManufacturerOrgSupport {
    ...
    private synchronized void initIfNeeded() {
        if (this.ranges.isEmpty()) {
            ...
            add(new int[]{385}, "HR");
            add(new int[]{387}, "BA");
            add(new int[]{TokenId.Identifier, 440}, "DE");
            ...
            add(new int[]{478}, "UZ");
            add(new int[]{479}, "LK");
            add(new int[]{CameraConst.DEFAULT_HEIGHT}, "PH");
            add(new int[]{481}, "BY");
            add(new int[]{482}, "UA");
            add(new int[]{484}, "MD");
            add(new int[]{485}, "AM");
            ...
            add(new int[]{628}, "SA");
            add(new int[]{629}, "AE");
            add(new int[]{CameraConst.DEFAULT_WIDTH, 649}, "FI");
            ...
            add(new int[]{Defines.PDF_MAX_H, 839}, "IT");
            ...
            add(new int[]{893}, "VN");
            add(new int[]{896}, "PK");
            add(new int[]{899}, ConnectWhenOpenContentsDialog.ID);
