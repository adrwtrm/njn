...
public final class WifiResultParser extends ResultParser {
    ...
    public WifiParsedResult parse(Result result) {
        ...
        } else if (matchSinglePrefixedField4 != null || CommonDefine.TRUE.equalsIgnoreCase(matchSinglePrefixedField5) || CommonDefine.FALSE.equalsIgnoreCase(matchSinglePrefixedField5)) {
            str = matchSinglePrefixedField4;
