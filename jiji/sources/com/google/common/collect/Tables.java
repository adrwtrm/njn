...
public final class Tables {
    ...
    public static abstract class AbstractCell<R, C, V> implements Table.Cell<R, C, V> {
        ...
        public String toString() {
            ...
            return new StringBuilder(String.valueOf(valueOf).length() + 4 + String.valueOf(valueOf2).length() + String.valueOf(valueOf3).length()).append("(").append(valueOf).append(RemotePrefUtils.SEPARATOR).append(valueOf2).append(")=").append(valueOf3).toString();
        }
    }
