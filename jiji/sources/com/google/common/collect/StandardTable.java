...
public class StandardTable<R, C, V> extends AbstractTable<R, C, V> implements Serializable {
    ...
    private class CellIterator implements Iterator<Table.Cell<R, C, V>> {
        ...
        private CellIterator() {
            StandardTable.this = r1;
            this.rowIterator = r1.backingMap.entrySet().iterator();
    ...
    Spliterator<Table.Cell<R, C, V>> cellSpliterator() {
        return CollectSpliterators.flatMap(this.backingMap.entrySet().spliterator(), new Function() { // from class: com.google.common.collect.StandardTable$$ExternalSyntheticLambda1
            ...
            public final Object apply(Object obj) {
                return StandardTable.lambda$cellSpliterator$1((Map.Entry) obj);
            }
        }, 65, size());
    }

    public static /* synthetic */ Spliterator lambda$cellSpliterator$1(final Map.Entry entry) {
        return CollectSpliterators.map(((Map) entry.getValue()).entrySet().spliterator(), new Function() { // from class: com.google.common.collect.StandardTable$$ExternalSyntheticLambda0
            @Override // java.util.function.Function
            public final Object apply(Object obj) {
                return StandardTable.lambda$cellSpliterator$0(entry, (Map.Entry) obj);
            }
        });
    }

    public static /* synthetic */ Table.Cell lambda$cellSpliterator$0(Map.Entry entry, Map.Entry entry2) {
    ...
    public class ColumnKeyIterator extends AbstractIterator<C> {
        ...
        private ColumnKeyIterator() {
            StandardTable.this = r2;
            this.seen = r2.factory.get();
            this.mapIterator = r2.backingMap.values().iterator();
