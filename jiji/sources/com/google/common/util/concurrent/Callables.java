    ...
    public static <T> AsyncCallable<T> asAsyncCallable(final Callable<T> callable, final ListeningExecutorService listeningExecutorService) {
        ...
        return new AsyncCallable() { // from class: com.google.common.util.concurrent.Callables$$ExternalSyntheticLambda3
            ...
            public final ListenableFuture call() {
                return Callables.lambda$asAsyncCallable$1(ListeningExecutorService.this, callable);
            }
        };
    }

    public static /* synthetic */ ListenableFuture lambda$asAsyncCallable$1(ListeningExecutorService listeningExecutorService, Callable callable) throws Exception {
