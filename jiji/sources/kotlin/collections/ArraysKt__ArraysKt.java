        ...
        for (int i = 0; i < length; i++) {
            ...
            if (t != t2) {
                ...
                if ((t instanceof Object[]) && (t2 instanceof Object[])) {
                    ...
                    if (!UArraysKt.m907contentEqualskV0jMPg(((UByteArray) t).m422unboximpl(), ((UByteArray) t2).m422unboximpl())) {
                        return false;
                    }
                } else if ((t instanceof UShortArray) && (t2 instanceof UShortArray)) {
                    if (!UArraysKt.m904contentEqualsFGO6Aew(((UShortArray) t).m685unboximpl(), ((UShortArray) t2).m685unboximpl())) {
                        return false;
                    }
                } else if ((t instanceof UIntArray) && (t2 instanceof UIntArray)) {
                    if (!UArraysKt.m905contentEqualsKJPZfPQ(((UIntArray) t).m501unboximpl(), ((UIntArray) t2).m501unboximpl())) {
                        return false;
                    }
                } else if ((t instanceof ULongArray) && (t2 instanceof ULongArray)) {
                    if (!UArraysKt.m909contentEqualslec5QzE(((ULongArray) t).m580unboximpl(), ((ULongArray) t2).m580unboximpl())) {
                        return false;
                    }
    ...
    private static final <T> void contentDeepToStringInternal$ArraysKt__ArraysKt(T[] tArr, StringBuilder sb, List<Object[]> list) {
        ...
        for (int i = 0; i < length; i++) {
            ...
            if (t == null) {
                ...
                sb.append(UArraysKt.m921contentToString2csIQuQ(uByteArray != null ? uByteArray.m422unboximpl() : null));
            } else if (t instanceof UShortArray) {
                UShortArray uShortArray = (UShortArray) t;
                sb.append(UArraysKt.m925contentToStringd6D3K8(uShortArray != null ? uShortArray.m685unboximpl() : null));
            } else if (t instanceof UIntArray) {
                UIntArray uIntArray = (UIntArray) t;
                sb.append(UArraysKt.m924contentToStringXUkPCBk(uIntArray != null ? uIntArray.m501unboximpl() : null));
            } else if (t instanceof ULongArray) {
                ULongArray uLongArray = (ULongArray) t;
                sb.append(UArraysKt.m927contentToStringuLth9ew(uLongArray != null ? uLongArray.m580unboximpl() : null));
            } else {
