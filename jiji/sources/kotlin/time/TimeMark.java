...
public interface TimeMark {
    ...
    TimeMark mo1653minusLRDsOJo(long j);

    /* renamed from: plus-LRDsOJo */
    TimeMark mo1655plusLRDsOJo(long j);
    ...
    public static final class DefaultImpls {
        ...
        public static TimeMark m1799minusLRDsOJo(TimeMark timeMark, long j) {
            return timeMark.mo1655plusLRDsOJo(Duration.m1715unaryMinusUwyO8pc(j));
        }

        public static boolean hasPassedNow(TimeMark timeMark) {
            return !Duration.m1696isNegativeimpl(timeMark.mo1652elapsedNowUwyO8pc());
        }
