...
final class AdjustedTimeMark implements TimeMark {
    ...
    public TimeMark mo1653minusLRDsOJo(long j) {
        return TimeMark.DefaultImpls.m1799minusLRDsOJo(this, j);
    }

    /* renamed from: getAdjustment-UwyO8pc  reason: not valid java name */
    public final long m1657getAdjustmentUwyO8pc() {
    ...
    public long mo1652elapsedNowUwyO8pc() {
        return Duration.m1698minusLRDsOJo(this.mark.mo1652elapsedNowUwyO8pc(), this.adjustment);
    }

    @Override // kotlin.time.TimeMark
    /* renamed from: plus-LRDsOJo */
    public TimeMark mo1655plusLRDsOJo(long j) {
        return new AdjustedTimeMark(this.mark, Duration.m1699plusLRDsOJo(this.adjustment, j), null);
    }
}
