...
public final class UStringsKt {
    ...
    public static final UByte toUByteOrNull(String str, int i) {
        ...
        if (uIntOrNull != null) {
            ...
            if (Integer.compareUnsigned(m484unboximpl, UInt.m432constructorimpl(255)) > 0) {
                return null;
            }
    ...
    public static final UShort toUShortOrNull(String str, int i) {
        ...
        if (uIntOrNull != null) {
            int m484unboximpl = uIntOrNull.m484unboximpl();
            if (Integer.compareUnsigned(m484unboximpl, UInt.m432constructorimpl(SupportMenu.USER_MASK)) > 0) {
                return null;
            }
    ...
    public static final UInt toUIntOrNull(String str, int i) {
        ...
        while (i2 < length) {
            ...
            if (Integer.compareUnsigned(i3, i4) > 0) {
                if (i4 == 119304647) {
                    i4 = Integer.divideUnsigned(-1, m432constructorimpl);
                    if (Integer.compareUnsigned(i3, i4) > 0) {
                    }
                }
                return null;
            ...
            if (Integer.compareUnsigned(m432constructorimpl3, m432constructorimpl2) < 0) {
                return null;
            }
            i2++;
        ...
        while (i2 < length) {
            ...
            if (Long.compareUnsigned(j, j2) > 0) {
                if (j2 == 512409557603043100L) {
                    j2 = Long.divideUnsigned(-1L, m511constructorimpl);
                    if (Long.compareUnsigned(j, j2) > 0) {
                    }
                }
                return null;
            ...
            long m511constructorimpl3 = ULong.m511constructorimpl(ULong.m511constructorimpl(UInt.m432constructorimpl(digitOf) & 4294967295L) + m511constructorimpl2);
            if (Long.compareUnsigned(m511constructorimpl3, m511constructorimpl2) < 0) {
                return null;
            }
            i2++;
