...
public final class UMathKt {
    ...
    private static final int m1561minJ1ME1BU(int i, int i2) {
        return UComparisonsKt.m1543minOfJ1ME1BU(i, i2);
    }

    /* renamed from: min-eb3DHEI  reason: not valid java name */
    private static final long m1562mineb3DHEI(long j, long j2) {
        return UComparisonsKt.m1551minOfeb3DHEI(j, j2);
    }

    /* renamed from: max-J1ME1BU  reason: not valid java name */
    private static final int m1559maxJ1ME1BU(int i, int i2) {
        return UComparisonsKt.m1531maxOfJ1ME1BU(i, i2);
    }

    /* renamed from: max-eb3DHEI  reason: not valid java name */
    private static final long m1560maxeb3DHEI(long j, long j2) {
        return UComparisonsKt.m1539maxOfeb3DHEI(j, j2);
    }
}
