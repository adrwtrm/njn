...
public final class UInt implements Comparable<UInt> {
    ...
    public /* bridge */ /* synthetic */ int compareTo(UInt uInt) {
        return UnsignedKt.uintCompare(m484unboximpl(), uInt.m484unboximpl());
    }
    ...
    private static final int m427compareTo7apg3OU(int i, byte b) {
        return Integer.compareUnsigned(i, m432constructorimpl(b & 255));
    }

    /* renamed from: compareTo-xj2QHRw */
    private static final int m431compareToxj2QHRw(int i, short s) {
        return Integer.compareUnsigned(i, m432constructorimpl(s & UShort.MAX_VALUE));
    }

    /* renamed from: compareTo-WZ4Q5Ns */
    private int m429compareToWZ4Q5Ns(int i) {
        return UnsignedKt.uintCompare(m484unboximpl(), i);
    }
    ...
    private static final int m428compareToVKZWuLQ(int i, long j) {
        return Long.compareUnsigned(ULong.m511constructorimpl(i & 4294967295L), j);
    }

    /* renamed from: plus-7apg3OU */
    private static final int m456plus7apg3OU(int i, byte b) {
        return m432constructorimpl(i + m432constructorimpl(b & 255));
    }
    ...
    private static final long m457plusVKZWuLQ(int i, long j) {
        return ULong.m511constructorimpl(ULong.m511constructorimpl(i & 4294967295L) + j);
    }
    ...
    private static final int m434div7apg3OU(int i, byte b) {
        return Integer.divideUnsigned(i, m432constructorimpl(b & 255));
    }

    /* renamed from: div-xj2QHRw */
    private static final int m437divxj2QHRw(int i, short s) {
        return Integer.divideUnsigned(i, m432constructorimpl(s & UShort.MAX_VALUE));
    }

    /* renamed from: div-WZ4Q5Ns */
    private static final int m436divWZ4Q5Ns(int i, int i2) {
        return UnsignedKt.m688uintDivideJ1ME1BU(i, i2);
    }

    /* renamed from: div-VKZWuLQ */
    private static final long m435divVKZWuLQ(int i, long j) {
        return Long.divideUnsigned(ULong.m511constructorimpl(i & 4294967295L), j);
    }

    /* renamed from: rem-7apg3OU */
    private static final int m462rem7apg3OU(int i, byte b) {
        return Integer.remainderUnsigned(i, m432constructorimpl(b & 255));
    }

    /* renamed from: rem-xj2QHRw */
    private static final int m465remxj2QHRw(int i, short s) {
        return Integer.remainderUnsigned(i, m432constructorimpl(s & UShort.MAX_VALUE));
    }

    /* renamed from: rem-WZ4Q5Ns */
    private static final int m464remWZ4Q5Ns(int i, int i2) {
        return UnsignedKt.m689uintRemainderJ1ME1BU(i, i2);
    }

    /* renamed from: rem-VKZWuLQ */
    private static final long m463remVKZWuLQ(int i, long j) {
        return Long.remainderUnsigned(ULong.m511constructorimpl(i & 4294967295L), j);
    }
    ...
    private static final byte m451mod7apg3OU(int i, byte b) {
        return UByte.m355constructorimpl((byte) Integer.remainderUnsigned(i, m432constructorimpl(b & 255)));
    }

    /* renamed from: mod-xj2QHRw */
    private static final short m454modxj2QHRw(int i, short s) {
        return UShort.m618constructorimpl((short) Integer.remainderUnsigned(i, m432constructorimpl(s & UShort.MAX_VALUE)));
    }
    ...
    private static final UIntRange m461rangeUntilWZ4Q5Ns(int i, int i2) {
        return URangesKt.m1617untilJ1ME1BU(i, i2);
    }
    ...
    private static final long m481toULongsVKNKU(int i) {
        return ULong.m511constructorimpl(i & 4294967295L);
    }
