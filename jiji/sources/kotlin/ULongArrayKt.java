...
public final class ULongArrayKt {
    ...
    private static final long[] m582ulongArrayOfQwZRm1k(long... elements) {
    ...
    private static final long[] ULongArray(int i, Function1<? super Integer, ULong> init) {
        ...
        for (int i2 = 0; i2 < i; i2++) {
            jArr[i2] = init.invoke(Integer.valueOf(i2)).m563unboximpl();
        }
        return ULongArray.m566constructorimpl(jArr);
    }
}
