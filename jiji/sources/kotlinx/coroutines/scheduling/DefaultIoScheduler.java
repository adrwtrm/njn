...
public final class DefaultIoScheduler extends ExecutorCoroutineDispatcher implements Executor {
    ...
    static {
        ...
        f4default = unlimitedIoScheduler.limitedParallelism(systemProp$default);
    }
    ...
    public void execute(Runnable runnable) {
        mo1890dispatch(EmptyCoroutineContext.INSTANCE, runnable);
    }
    ...
    public void mo1890dispatch(CoroutineContext coroutineContext, Runnable runnable) {
        f4default.mo1890dispatch(coroutineContext, runnable);
    }
