...
public interface SendChannel<E> {
    ...
    Object mo1844trySendJP2dKIU(E e);
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) {
            ...
            if (ChannelResult.m1859isSuccessimpl(mo1844trySendJP2dKIU)) {
                return true;
            }
            Throwable m1853exceptionOrNullimpl = ChannelResult.m1853exceptionOrNullimpl(mo1844trySendJP2dKIU);
