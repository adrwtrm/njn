...
public class ChannelCoroutine<E> extends AbstractCoroutine<Unit> implements Channel<E> {
    ...
    public Object mo1842receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation) {
        Object obj = this._channel.mo1842receiveCatchingJP2dKIU(continuation);
    ...
    public Object mo1843tryReceivePtdJZtk() {
        return this._channel.mo1843tryReceivePtdJZtk();
    }

    @Override // kotlinx.coroutines.channels.SendChannel
    /* renamed from: trySend-JP2dKIU */
    public Object mo1844trySendJP2dKIU(E e) {
        return this._channel.mo1844trySendJP2dKIU(e);
    }
