...
final /* synthetic */ class ChannelsKt__ChannelsKt {
    ...
    public static final <E> Object trySendBlocking(SendChannel<? super E> sendChannel, E e) {
        ...
        Object mo1844trySendJP2dKIU = sendChannel.mo1844trySendJP2dKIU(e);
        if (mo1844trySendJP2dKIU instanceof ChannelResult.Failed) {
            ...
            return ((ChannelResult) runBlocking$default).m1861unboximpl();
        }
        Unit unit = (Unit) mo1844trySendJP2dKIU;
    ...
    public static final <E> void sendBlocking(SendChannel<? super E> sendChannel, E e) {
        if (ChannelResult.m1859isSuccessimpl(sendChannel.mo1844trySendJP2dKIU(e))) {
            return;
        }
