...
final class ReceiveChannel$onReceiveOrNull$1$registerSelectClause1$1<E, R> extends SuspendLambda implements Function2<ChannelResult<? extends E>, Continuation<? super R>, Object> {
    ...
    public /* bridge */ /* synthetic */ Object invoke(Object obj, Object obj2) {
        return m1865invokeWpGqRn0(((ChannelResult) obj).m1861unboximpl(), (Continuation) obj2);
    }

    /* renamed from: invoke-WpGqRn0  reason: not valid java name */
    public final Object m1865invokeWpGqRn0(Object obj, Continuation<? super R> continuation) {
        return ((ReceiveChannel$onReceiveOrNull$1$registerSelectClause1$1) create(ChannelResult.m1849boximpl(obj), continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            Object m1861unboximpl = ((ChannelResult) this.L$0).m1861unboximpl();
            Throwable m1853exceptionOrNullimpl = ChannelResult.m1853exceptionOrNullimpl(m1861unboximpl);
            if (m1853exceptionOrNullimpl != null) {
                throw m1853exceptionOrNullimpl;
            }
            Object m1854getOrNullimpl = ChannelResult.m1854getOrNullimpl(m1861unboximpl);
            this.label = 1;
            obj = this.$block.invoke(m1854getOrNullimpl, this);
