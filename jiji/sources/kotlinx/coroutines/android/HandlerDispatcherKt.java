...
public final class HandlerDispatcherKt {
    ...
    public static /* synthetic */ void $r8$lambda$Z1vOW_gMqzuAA1kBf19jmX0gPxw(CancellableContinuation cancellableContinuation, long j) {
        m1840postFrameCallback$lambda6(cancellableContinuation, j);
    }
    ...
    static {
        ...
        try {
            ...
            m337constructorimpl = Result.m337constructorimpl(new HandlerContext(asHandler(Looper.getMainLooper(), true), null, 2, null));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.Companion;
            m337constructorimpl = Result.m337constructorimpl(ResultKt.createFailure(th));
        }
        Main = Result.m343isFailureimpl(m337constructorimpl) ? null : m337constructorimpl;
    }
    ...
    public static final Object awaitFrame(Continuation<? super Long> continuation) {
        ...
        Dispatchers.getMain().mo1890dispatch(EmptyCoroutineContext.INSTANCE, new Runnable() { // from class: kotlinx.coroutines.android.HandlerDispatcherKt$awaitFrame$lambda-3$$inlined$Runnable$1
    ...
    public static final void m1840postFrameCallback$lambda6(CancellableContinuation cancellableContinuation, long j) {
